...
[Prebuilt binaries](https://github.com/TosinShada/stellar-core/releases) of the federation server are available on the [releases page](https://github.com/TosinShada/stellar-core/releases).
...
```
go get -u github.com/TosinShada/stellar-core/services/federation
```
